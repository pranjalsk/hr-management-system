<%@ Page Title="" Language="C#" MasterPageFile="~/UI/HRS_master.Master" AutoEventWireup="true" CodeBehind="CreateEmployee.aspx.cs" Inherits="HRS_CaseStudy_2.UI.CreateEmployee" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <p style="background-image: url('images/master back.jpg'); background-repeat: repeat">
        <br />
        <table id="Table1" border="0" cellpadding="1" cellspacing="1" height="100%" 
            ...
            <tr>
                <td align="center" class="header" colspan="6" style="background-color: #FF99CC">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td class="label">
                                Middle Name:</td>
                            <td>
                                <asp:TextBox ID="add_mname" runat="server"></asp:TextBox>
...
&nbsp;<asp:TextBox ID="add_bday" runat="server" ReadOnly="True"></asp:TextBox>
                                ...
                                <div id="datePicker">
                                    ...
                                    runat="server" 
                                        ...
                                        style="height: 215px; width: 305px" onselectionchanged="Calendar1_SelectionChanged" 
                                   >
                                </asp:Calendar></div>
            ...
            <tr>
                <td align="center" class="header" colspan="6" style="background-color: #66CCFF">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td class="label">
                                Citizenship:</td>
                            <td>
                                <asp:TextBox ID="add_citizen" runat="server" 
                                   ></asp:TextBox>
            ...
            <tr>
                <td colspan="6">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center" class="header" colspan="2" style="background-color: #FF99CC" 
                                width="50%">
                                Home Address</td>
                            <td align="center" class="header" colspan="2" style="background-color: #FF99CC" 
                                width="50%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                    ControlToValidate="add_street" ErrorMessage="Required Field is missing">*</asp:RequiredFieldValidator>
                            ...
                            <td class="label">
                                Mobile Phone:</td>
                            <td>
                                <asp:TextBox ID="add_mob" runat="server" ontextchanged="add_mob_TextChanged"></asp:TextBox>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator18" 
                                    runat="server" ControlToValidate="add_mob" 
                                    ErrorMessage="Please enter valid input" 
                                    ValidationExpression="[\w_,\n\r\s\\\+\.\-/#()]*">*</asp:RegularExpressionValidator>
                                <asp:CustomValidator ID="CustomValidator1" runat="server" 
                                    ControlToValidate="add_mob" ErrorMessage="Please enter a valid mobile no.">*</asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="label">
                                City:<asp:ValidationSummary 
                                    ID="ValidationSummary1" runat="server" 
                                    
                                    
                                    style="z-index: 1; left: 1053px; top: 362px; position: absolute; height: 238px; width: 258px" />
                            </td>
                            <td colspan="5">
...
&nbsp;<asp:TextBox ID="add_hired" runat="server" ReadOnly="True"></asp:TextBox>
                                ...
                                <asp:Calendar ID="Calendar2" runat="server" 
                                        onselectionchanged="Calendar2_SelectionChanged" style="height: 196px; width: 294px" 
                                  >
                                </asp:Calendar>
                                </div>
                        ...
                        <tr>
                            <td align="left" class="header" colspan="6" style="background-color: #FF99CC">
                        ...
                        <tr>
                            <td colspan="6">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
                                    ControlToValidate="add_edc_back" ErrorMessage="Required Field is missing">*</asp:RequiredFieldValidator>
                        ...
                        <tr>
                            <td align="left" class="header" colspan="6" style="background-color: #66CCFF">
